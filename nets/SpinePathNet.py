...
#for basic convolutional network.
...
#for basic convolutional network and adverisal network. without lstm.
...
#basic convolutional network + adverisal network + lstm.
